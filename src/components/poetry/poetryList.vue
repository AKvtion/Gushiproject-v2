...
<template>
  <div class="gushiList">
    ...
    <el-table :data="compData" border style="width: 100%">
      ...
      <el-table-column prop="title" width="100px" label="标题" align="center">
      </el-table-column>
      <el-table-column prop="author" width="70px" label="作者" align="center">
      </el-table-column>
      <el-table-column prop="country" width="70px" label="朝代" align="center">
      </el-table-column>
    ...
    <el-dialog :title="state ? '添加古诗信息' : '修改古诗信息'" :visible.sync="dialogFormVisible" width="900px">
      <el-form :model="form" :rules="rules" ref="form">
        ...
        <el-form-item label="简介" :label-width="formLabelWidth" prop="introduce">
          <el-input :autosize="{ minRows: 2, maxRows: 8}" type="textarea" v-model="form.introduce" autocomplete="off"></el-input>
        </el-form-item>
        ...
        <el-form-item label="注释" :label-width="formLabelWidth" prop="comment">
          <el-input :autosize="{ minRows: 2, maxRows: 8}" type="textarea" v-model="form.comment" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="赏析" :label-width="formLabelWidth" prop="appreciation">
          <el-input :autosize="{ minRows: 2, maxRows: 8}"  type="textarea" v-model="form.appreciation" autocomplete="off"></el-input>
        </el-form-item>
